<%@ Page Language="C#" MasterPageFile="~/PopUp.Master" AutoEventWireup="true" Inherits="StudentPractice.Portal.Secure.Admin.CreateIncidentType"
    CodeBehind="CreateIncidentType.aspx.cs" Title="Αναφορά Συμβάντος" %>

<%@ Register Src="~/Secure/Admin/UserControls/IncidentTypeInput.ascx" TagName="IncidentTypeInput"
    TagPrefix="my" %>
