<%@ Page Language="C#" MasterPageFile="~/Secure/SecurePages.Master" AutoEventWireup="true" Inherits="StudentPractice.Portal.Secure.InternshipOffices.EditOfficeUser"
    CodeBehind="EditOfficeUser.aspx.cs" Title="Δημιουργία Χρήστη" %>
...
<asp:Content ContentPlaceHolderID="cphMain" runat="server">
    <div style="margin: 10px;">
        ...
        <my:OfficeUserInput ID="ucOfficeUserInput" runat="server" ValidationGroup="vgOfficeUser" EditMode="true" ReadOnly="false" />
    </div>
