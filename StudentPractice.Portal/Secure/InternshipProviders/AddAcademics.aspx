<%@ Page Language="C#" MasterPageFile="~/PopUp.Master" AutoEventWireup="true" Inherits="StudentPractice.Portal.Secure.InternshipProviders.AddAcademics" 
    CodeBehind="AddAcademics.aspx.cs" Title="Προσθήκη Σχολών/Τμημάτων" %>
    ...
    <div style="margin: 5px;">
        <asp:MultiView ID="mv" runat="server" ActiveViewIndex="0">
            <asp:View ID="vSelect" runat="server">
                <dx:ASPxGridView ID="gvAcademics" runat="server" AutoGenerateColumns="False" EnableRowsCache="false" EnableCallBacks="true" Width="100%" KeyFieldName="ID">
                ...
                <div style="text-align: left; margin-top: 10px">
                    <asp:LinkButton ID="btnContinue" runat="server" Text="<%$ Resources:GlobalProvider, Global_Continue %>" CssClass="icon-btn bg-next" OnClick="btnContinue_Click" />
                    <asp:LinkButton ID="btnCancel" runat="server" Text="<%$ Resources:GlobalProvider, Global_Cancel %>" CssClass="icon-btn bg-cancel" OnClick="btnCancel_Click" />
                </div>
            </asp:View>
            ...
            <asp:View ID="vAccept" runat="server">
                <div style="text-align: left; margin-top: 10px">
                    ...
                    <asp:LinkButton ID="btnSubmit" runat="server" Text="<%$ Resources:AddAcademics, DescriptionsAccept %>" CssClass="icon-btn bg-accept" OnClick="btnSubmit_Click" />
                </div>
                <br />
