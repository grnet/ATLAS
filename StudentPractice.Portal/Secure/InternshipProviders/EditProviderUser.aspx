<%@ Page Language="C#" MasterPageFile="~/Secure/SecurePages.Master" AutoEventWireup="true" Inherits="StudentPractice.Portal.Secure.InternshipProviders.EditProviderUser"
    CodeBehind="EditProviderUser.aspx.cs" Title="Δημιουργία Χρήστη" %>
...
<asp:Content ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div style="margin: 10px;">
        <asp:ValidationSummary ID="vsSummary" runat="server" CssClass="validation-summary"
            ValidationGroup="vgProviderUser" HeaderText="<%$ Resources:ProviderUser, ValidationProviderUser %>" />
        <asp:Label ID="lblValidationErrors" runat="server" CssClass="error" />
        <my:ProviderUserInput ID="ucProviderUserInput" runat="server" ValidationGroup="vgProviderUser" EditMode="true" ReadOnly="false"  />
    </div>
