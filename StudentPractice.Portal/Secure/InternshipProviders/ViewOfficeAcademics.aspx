<%@ Page Language="C#" MasterPageFile="~/PopUp.Master" AutoEventWireup="true" Inherits="StudentPractice.Portal.Secure.InternshipProviders.ViewOfficeAcademics"
    ...
    <table style="width: 100%">
        <tr>
            <td colspan="2" style="text-align: left; padding-left: 7px;">
                <asp:LinkButton ID="btnCancel" runat="server" Text="<%$ Resources:GlobalProvider, Global_Close %>" CssClass="icon-btn bg-cancel"
