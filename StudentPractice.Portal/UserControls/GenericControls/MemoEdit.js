...
StudentPractice.Portal.UserControls.GenericControls.MemoEdit = function (element) {
    StudentPractice.Portal.UserControls.GenericControls.MemoEdit.initializeBase(this, [element]);
...
StudentPractice.Portal.UserControls.GenericControls.MemoEdit.prototype = {
    initialize: function () {
        StudentPractice.Portal.UserControls.GenericControls.MemoEdit.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        ...
        StudentPractice.Portal.UserControls.GenericControls.MemoEdit.callBaseMethod(this, 'dispose');
    },
    ...
    _updateCounter: function (event) {
        ...
        if (currentText != null && currentText.length >= this._maxLength) {
            ...
            if (showAlert) {
                alert(Resources.MemoEdit_UpdateCounter);
    ...
    _setCounterText: function (text) {
        ...
        if (this.get_counterText() != null) {
            ...
            this._spCharCounter.innerHTML = Resources.MemoEdit_Info.replace("{0}", this._maxLength).replace("{1}", chars);
        }
    },
...
StudentPractice.Portal.UserControls.GenericControls.MemoEdit.registerClass('StudentPractice.Portal.UserControls.GenericControls.MemoEdit', Sys.UI.Control);